    ...
    <section id="sectors" className="sectors-section py-32 bg-navy relative scroll-mt-20">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-24">
          ...
          <h3 className="font-serif text-4xl md:text-5xl text-silver">
            The {VERTICALS.length} Pillars of <span className="italic text-gold">Excellence</span>
          </h3>
          <div className="w-24 h-1 bg-gradient-to-r from-navy-lighter to-gold mx-auto mt-8"></div>
        </div>

        <div className="sector-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {VERTICALS.map((vertical, index) => (
            ...
            >
              <Link
                ...
                className="sector-card group relative overflow-hidden glass-panel p-1 block h-full"
              >
